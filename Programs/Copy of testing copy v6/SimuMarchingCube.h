...
public:
	...
	CString m_mcExportVectorFormat;
	...
	void ExportMarchingCubeSurfaceMeshIntoPOVRayMesh2ObjectFile(CString &txFileName, FILE* fp);
	...
	void ExecuteMarchingCube(UINT gridDim[3]);
