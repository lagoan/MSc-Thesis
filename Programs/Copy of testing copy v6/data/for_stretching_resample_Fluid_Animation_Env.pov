...
#declare Moving_Cylinder_Thickness = 5;                       

#declare Left_Moving_Cylinder = 
cylinder {
        left_cyl__m_cylTopCtrPos,
        <left_cyl__m_cylBtmCtrPos.x - left_cyl__m_cylCapHeight,
...
cylinder {
        right_cyl__m_cylTopCtrPos,
        <right_cyl__m_cylBtmCtrPos.x + right_cyl__m_cylCapHeight,
