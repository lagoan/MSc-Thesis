/* average times: interact=0.000469 s/f, motion=2.189969 s/f, downsample=0.002906 s/f, upsample=0.535156 s/f, and total=6.235781 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -70.031250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0032.txt"
#else
	#include "surface_mesh_fluid_box_0032.inc"
