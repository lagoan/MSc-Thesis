/* average times: interact=0.001125 s/f, motion=2.986750 s/f, downsample=0.003500 s/f, upsample=0.773450 s/f, and total=7.073800 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -88.031250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0040.txt"
#else
	#include "surface_mesh_fluid_box_0040.inc"
