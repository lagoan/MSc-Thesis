/* average times: interact=0.001071 s/f, motion=3.148119 s/f, downsample=0.003714 s/f, upsample=0.820690 s/f, and total=7.239190 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -92.531250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0042.txt"
#else
	#include "surface_mesh_fluid_box_0042.inc"
