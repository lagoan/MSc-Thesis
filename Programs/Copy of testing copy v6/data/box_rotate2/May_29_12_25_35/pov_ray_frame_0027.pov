/* average times: interact=0.000000 s/f, motion=1.455037 s/f, downsample=0.001148 s/f, upsample=0.312481 s/f, and total=5.485593 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -58.781250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0027.txt"
#else
	#include "surface_mesh_fluid_box_0027.inc"
