/* average times: interact=0.000882 s/f, motion=2.418676 s/f, downsample=0.003206 s/f, upsample=0.603882 s/f, and total=6.473765 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -74.531250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0034.txt"
#else
	#include "surface_mesh_fluid_box_0034.inc"
