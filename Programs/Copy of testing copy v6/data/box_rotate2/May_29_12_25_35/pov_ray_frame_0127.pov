/* average times: interact=0.002331 s/f, motion=5.156417 s/f, downsample=0.008961 s/f, upsample=1.081276 s/f, and total=9.407205 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -283.781250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0127.txt"
#else
	#include "surface_mesh_fluid_box_0127.inc"
