/* average times: interact=0.000000 s/f, motion=0.000000 s/f, downsample=0.000000 s/f, upsample=0.000000 s/f, and total=3.906000 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0001.txt"
#else
	#include "surface_mesh_fluid_box_0001.inc"
