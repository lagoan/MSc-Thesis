/* average times: interact=0.000000 s/f, motion=0.006350 s/f, downsample=0.000000 s/f, upsample=0.000000 s/f, and total=4.004700 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -43.031250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0020.txt"
#else
	#include "surface_mesh_fluid_box_0020.inc"
