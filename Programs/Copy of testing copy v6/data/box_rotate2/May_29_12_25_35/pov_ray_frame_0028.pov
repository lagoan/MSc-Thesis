/* average times: interact=0.000000 s/f, motion=1.630143 s/f, downsample=0.001643 s/f, upsample=0.367179 s/f, and total=5.668536 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -61.031250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0028.txt"
#else
	#include "surface_mesh_fluid_box_0028.inc"
