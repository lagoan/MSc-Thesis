/* average times: interact=0.001000 s/f, motion=3.372267 s/f, downsample=0.004156 s/f, upsample=0.885444 s/f, and total=7.477400 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -99.281250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0045.txt"
#else
	#include "surface_mesh_fluid_box_0045.inc"
