/* average times: interact=0.001047 s/f, motion=3.224953 s/f, downsample=0.003628 s/f, upsample=0.843395 s/f, and total=7.317535 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -94.781250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0043.txt"
#else
	#include "surface_mesh_fluid_box_0043.inc"
