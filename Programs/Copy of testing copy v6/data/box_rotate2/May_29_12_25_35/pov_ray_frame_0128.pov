/* average times: interact=0.002555 s/f, motion=5.163250 s/f, downsample=0.008891 s/f, upsample=1.080148 s/f, and total=9.415008 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -286.031250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0128.txt"
#else
	#include "surface_mesh_fluid_box_0128.inc"
