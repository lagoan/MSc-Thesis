/* average times: interact=0.000000 s/f, motion=2.063516 s/f, downsample=0.002484 s/f, upsample=0.498000 s/f, and total=6.107774 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -67.781250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0031.txt"
#else
	#include "surface_mesh_fluid_box_0031.inc"
