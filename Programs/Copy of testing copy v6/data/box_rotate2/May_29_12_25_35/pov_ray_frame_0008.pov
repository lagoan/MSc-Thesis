/* average times: interact=0.000000 s/f, motion=0.009875 s/f, downsample=0.000000 s/f, upsample=0.000000 s/f, and total=3.970500 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -16.031250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0008.txt"
#else
	#include "surface_mesh_fluid_box_0008.inc"
