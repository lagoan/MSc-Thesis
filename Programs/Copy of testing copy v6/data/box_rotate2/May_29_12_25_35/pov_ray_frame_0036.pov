/* average times: interact=0.001250 s/f, motion=2.625000 s/f, downsample=0.003028 s/f, upsample=0.666250 s/f, and total=6.693944 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -79.031250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0036.txt"
#else
	#include "surface_mesh_fluid_box_0036.inc"
