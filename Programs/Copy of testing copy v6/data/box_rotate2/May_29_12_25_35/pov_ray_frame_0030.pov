/* average times: interact=0.000000 s/f, motion=1.929700 s/f, downsample=0.002567 s/f, upsample=0.458333 s/f, and total=5.971767 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -65.531250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0030.txt"
#else
	#include "surface_mesh_fluid_box_0030.inc"
