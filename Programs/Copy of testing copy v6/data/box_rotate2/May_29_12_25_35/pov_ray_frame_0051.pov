/* average times: interact=0.000882 s/f, motion=3.751863 s/f, downsample=0.004608 s/f, upsample=0.990863 s/f, and total=7.893627 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -112.781250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0051.txt"
#else
	#include "surface_mesh_fluid_box_0051.inc"
