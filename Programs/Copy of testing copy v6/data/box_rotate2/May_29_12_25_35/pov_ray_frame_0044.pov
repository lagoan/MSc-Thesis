/* average times: interact=0.001023 s/f, motion=3.299750 s/f, downsample=0.003886 s/f, upsample=0.864727 s/f, and total=7.398750 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -97.031250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0044.txt"
#else
	#include "surface_mesh_fluid_box_0044.inc"
