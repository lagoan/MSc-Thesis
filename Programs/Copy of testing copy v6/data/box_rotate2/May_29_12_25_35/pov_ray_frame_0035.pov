/* average times: interact=0.001286 s/f, motion=2.527229 s/f, downsample=0.003114 s/f, upsample=0.636629 s/f, and total=6.589657 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -76.781250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0035.txt"
#else
	#include "surface_mesh_fluid_box_0035.inc"
