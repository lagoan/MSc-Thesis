/* average times: interact=0.002349 s/f, motion=5.149333 s/f, downsample=0.008905 s/f, upsample=1.082540 s/f, and total=9.398881 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -281.531250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0126.txt"
#else
	#include "surface_mesh_fluid_box_0126.inc"
