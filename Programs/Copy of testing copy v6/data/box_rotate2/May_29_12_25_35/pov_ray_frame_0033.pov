/* average times: interact=0.000455 s/f, motion=2.308242 s/f, downsample=0.002818 s/f, upsample=0.571515 s/f, and total=6.355515 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -72.281250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0033.txt"
#else
	#include "surface_mesh_fluid_box_0033.inc"
