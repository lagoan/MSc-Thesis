/* average times: interact=0.002631 s/f, motion=5.177800 s/f, downsample=0.008877 s/f, upsample=1.078069 s/f, and total=9.433377 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -290.531250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0130.txt"
#else
	#include "surface_mesh_fluid_box_0130.inc"
