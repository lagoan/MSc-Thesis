/* average times: interact=0.001184 s/f, motion=2.812974 s/f, downsample=0.003289 s/f, upsample=0.722053 s/f, and total=6.894737 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -83.531250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0038.txt"
#else
	#include "surface_mesh_fluid_box_0038.inc"
