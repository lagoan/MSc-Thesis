/* average times: interact=0.001216 s/f, motion=2.720027 s/f, downsample=0.002946 s/f, upsample=0.694703 s/f, and total=6.795135 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -81.281250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0037.txt"
#else
	#include "surface_mesh_fluid_box_0037.inc"
