/* average times: interact=0.002651 s/f, motion=5.170101 s/f, downsample=0.008822 s/f, upsample=1.079039 s/f, and total=9.424147 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -288.281250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0129.txt"
#else
	#include "surface_mesh_fluid_box_0129.inc"
