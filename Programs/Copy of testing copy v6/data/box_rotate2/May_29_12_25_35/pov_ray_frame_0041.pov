/* average times: interact=0.001098 s/f, motion=3.069780 s/f, downsample=0.003805 s/f, upsample=0.797268 s/f, and total=7.158902 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -90.281250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0041.txt"
#else
	#include "surface_mesh_fluid_box_0041.inc"
