/* average times: interact=0.001333 s/f, motion=4.719741 s/f, downsample=0.007506 s/f, upsample=1.134506 s/f, and total=8.922790 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -180.281250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0081.txt"
#else
	#include "surface_mesh_fluid_box_0081.inc"
