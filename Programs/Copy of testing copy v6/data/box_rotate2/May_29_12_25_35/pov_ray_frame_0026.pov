/* average times: interact=0.000000 s/f, motion=1.267038 s/f, downsample=0.001192 s/f, upsample=0.256615 s/f, and total=5.283154 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -56.531250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0026.txt"
#else
	#include "surface_mesh_fluid_box_0026.inc"
