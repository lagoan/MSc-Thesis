/* average times: interact=0.001154 s/f, motion=2.901487 s/f, downsample=0.003205 s/f, upsample=0.748410 s/f, and total=6.985949 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -85.781250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0039.txt"
#else
	#include "surface_mesh_fluid_box_0039.inc"
