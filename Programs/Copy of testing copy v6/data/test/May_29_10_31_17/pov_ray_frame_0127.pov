/* average times: interact=0.635039 s/f, motion=2.214063 s/f, downsample=0.004441 s/f, upsample=0.260685 s/f, and total=8.065307 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0127.txt"
#else
	#include "surface_mesh_eggwhite_0127.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0127.txt"
#else
	#include "surface_mesh_yolk0_0127.inc"
