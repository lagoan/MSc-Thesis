/* average times: interact=0.523412 s/f, motion=1.676324 s/f, downsample=0.002451 s/f, upsample=0.172784 s/f, and total=7.573686 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0102.txt"
#else
	#include "surface_mesh_eggwhite_0102.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0102.txt"
#else
	#include "surface_mesh_yolk0_0102.inc"
