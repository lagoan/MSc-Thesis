/* average times: interact=0.623685 s/f, motion=2.163169 s/f, downsample=0.004290 s/f, upsample=0.252129 s/f, and total=8.026323 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0124.txt"
#else
	#include "surface_mesh_eggwhite_0124.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0124.txt"
#else
	#include "surface_mesh_yolk0_0124.inc"
