/* average times: interact=0.568482 s/f, motion=1.923589 s/f, downsample=0.003500 s/f, upsample=0.222232 s/f, and total=7.830259 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0112.txt"
#else
	#include "surface_mesh_eggwhite_0112.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0112.txt"
#else
	#include "surface_mesh_yolk0_0112.inc"
