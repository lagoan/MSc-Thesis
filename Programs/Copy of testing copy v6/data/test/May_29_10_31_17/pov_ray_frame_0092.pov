/* average times: interact=0.473511 s/f, motion=1.433804 s/f, downsample=0.002217 s/f, upsample=0.137554 s/f, and total=7.319337 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0092.txt"
#else
	#include "surface_mesh_eggwhite_0092.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0092.txt"
#else
	#include "surface_mesh_yolk0_0092.inc"
