/* average times: interact=0.673650 s/f, motion=2.359146 s/f, downsample=0.004343 s/f, upsample=0.270066 s/f, and total=8.158299 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0137.txt"
#else
	#include "surface_mesh_eggwhite_0137.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0137.txt"
#else
	#include "surface_mesh_yolk0_0137.inc"
