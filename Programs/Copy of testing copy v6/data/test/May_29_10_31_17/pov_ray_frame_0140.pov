/* average times: interact=0.684771 s/f, motion=2.403786 s/f, downsample=0.004471 s/f, upsample=0.278457 s/f, and total=8.186257 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0140.txt"
#else
	#include "surface_mesh_eggwhite_0140.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0140.txt"
#else
	#include "surface_mesh_yolk0_0140.inc"
