/* average times: interact=0.371119 s/f, motion=1.100702 s/f, downsample=0.001310 s/f, upsample=0.088536 s/f, and total=7.009905 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0084.txt"
#else
	#include "surface_mesh_eggwhite_0084.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0084.txt"
#else
	#include "surface_mesh_yolk0_0084.inc"
