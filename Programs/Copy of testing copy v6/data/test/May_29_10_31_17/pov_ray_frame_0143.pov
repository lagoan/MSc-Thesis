/* average times: interact=0.694986 s/f, motion=2.442301 s/f, downsample=0.004378 s/f, upsample=0.284084 s/f, and total=8.205734 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0143.txt"
#else
	#include "surface_mesh_eggwhite_0143.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0143.txt"
#else
	#include "surface_mesh_yolk0_0143.inc"
