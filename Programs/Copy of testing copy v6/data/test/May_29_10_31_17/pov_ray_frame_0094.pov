/* average times: interact=0.486543 s/f, motion=1.474596 s/f, downsample=0.002170 s/f, upsample=0.134628 s/f, and total=7.358404 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0094.txt"
#else
	#include "surface_mesh_eggwhite_0094.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0094.txt"
#else
	#include "surface_mesh_yolk0_0094.inc"
