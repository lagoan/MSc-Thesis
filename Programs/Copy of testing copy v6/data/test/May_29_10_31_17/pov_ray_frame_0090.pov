/* average times: interact=0.455756 s/f, motion=1.356978 s/f, downsample=0.001744 s/f, upsample=0.114400 s/f, and total=7.245689 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0090.txt"
#else
	#include "surface_mesh_eggwhite_0090.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0090.txt"
#else
	#include "surface_mesh_yolk0_0090.inc"
