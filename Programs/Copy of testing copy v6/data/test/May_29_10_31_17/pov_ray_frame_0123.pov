/* average times: interact=0.620114 s/f, motion=2.151033 s/f, downsample=0.004325 s/f, upsample=0.254179 s/f, and total=8.019813 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0123.txt"
#else
	#include "surface_mesh_eggwhite_0123.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0123.txt"
#else
	#include "surface_mesh_yolk0_0123.inc"
