/* average times: interact=0.511525 s/f, motion=1.622677 s/f, downsample=0.002525 s/f, upsample=0.178020 s/f, and total=7.512343 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0099.txt"
#else
	#include "surface_mesh_eggwhite_0099.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0099.txt"
#else
	#include "surface_mesh_yolk0_0099.inc"
