/* average times: interact=0.666148 s/f, motion=2.338074 s/f, downsample=0.004407 s/f, upsample=0.274067 s/f, and total=8.148956 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0135.txt"
#else
	#include "surface_mesh_eggwhite_0135.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0135.txt"
#else
	#include "surface_mesh_yolk0_0135.inc"
