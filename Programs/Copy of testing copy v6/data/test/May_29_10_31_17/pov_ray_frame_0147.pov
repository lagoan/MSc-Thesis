/* average times: interact=0.708497 s/f, motion=2.487265 s/f, downsample=0.004367 s/f, upsample=0.288150 s/f, and total=8.226313 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0147.txt"
#else
	#include "surface_mesh_eggwhite_0147.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0147.txt"
#else
	#include "surface_mesh_yolk0_0147.inc"
