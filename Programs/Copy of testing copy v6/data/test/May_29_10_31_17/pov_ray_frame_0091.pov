/* average times: interact=0.465330 s/f, motion=1.410242 s/f, downsample=0.002242 s/f, upsample=0.139066 s/f, and total=7.298462 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0091.txt"
#else
	#include "surface_mesh_eggwhite_0091.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0091.txt"
#else
	#include "surface_mesh_yolk0_0091.inc"
