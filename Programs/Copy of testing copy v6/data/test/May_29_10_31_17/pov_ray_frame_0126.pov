/* average times: interact=0.631278 s/f, motion=2.187492 s/f, downsample=0.004222 s/f, upsample=0.248127 s/f, and total=8.042643 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0126.txt"
#else
	#include "surface_mesh_eggwhite_0126.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0126.txt"
#else
	#include "surface_mesh_yolk0_0126.inc"
