/* average times: interact=0.583261 s/f, motion=1.994713 s/f, downsample=0.003817 s/f, upsample=0.234904 s/f, and total=7.895939 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0115.txt"
#else
	#include "surface_mesh_eggwhite_0115.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0115.txt"
#else
	#include "surface_mesh_yolk0_0115.inc"
