/* average times: interact=0.550046 s/f, motion=1.830324 s/f, downsample=0.003046 s/f, upsample=0.207750 s/f, and total=7.736287 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0108.txt"
#else
	#include "surface_mesh_eggwhite_0108.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0108.txt"
#else
	#include "surface_mesh_yolk0_0108.inc"
