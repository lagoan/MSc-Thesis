/* average times: interact=0.654311 s/f, motion=2.289780 s/f, downsample=0.004386 s/f, upsample=0.266447 s/f, and total=8.116962 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0132.txt"
#else
	#include "surface_mesh_eggwhite_0132.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0132.txt"
#else
	#include "surface_mesh_yolk0_0132.inc"
