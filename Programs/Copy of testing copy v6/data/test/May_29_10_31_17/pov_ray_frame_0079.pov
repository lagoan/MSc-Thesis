/* average times: interact=0.268823 s/f, motion=0.819886 s/f, downsample=0.000810 s/f, upsample=0.060709 s/f, and total=6.751025 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0079.txt"
#else
	#include "surface_mesh_eggwhite_0079.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0079.txt"
#else
	#include "surface_mesh_yolk0_0079.inc"
