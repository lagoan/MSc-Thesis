/* average times: interact=0.406628 s/f, motion=1.190640 s/f, downsample=0.001279 s/f, upsample=0.086477 s/f, and total=7.091605 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0086.txt"
#else
	#include "surface_mesh_eggwhite_0086.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0086.txt"
#else
	#include "surface_mesh_yolk0_0086.inc"
