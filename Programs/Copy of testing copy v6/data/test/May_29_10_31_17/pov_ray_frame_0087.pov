/* average times: interact=0.421517 s/f, motion=1.262609 s/f, downsample=0.001805 s/f, upsample=0.118345 s/f, and total=7.161299 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0087.txt"
#else
	#include "surface_mesh_eggwhite_0087.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0087.txt"
#else
	#include "surface_mesh_yolk0_0087.inc"
