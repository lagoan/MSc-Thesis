/* average times: interact=0.681043 s/f, motion=2.394216 s/f, downsample=0.004504 s/f, upsample=0.280460 s/f, and total=8.182770 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0139.txt"
#else
	#include "surface_mesh_eggwhite_0139.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0139.txt"
#else
	#include "surface_mesh_yolk0_0139.inc"
