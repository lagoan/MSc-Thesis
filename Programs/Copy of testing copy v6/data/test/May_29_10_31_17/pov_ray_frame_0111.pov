/* average times: interact=0.563622 s/f, motion=1.906153 s/f, downsample=0.003532 s/f, upsample=0.224234 s/f, and total=7.814658 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0111.txt"
#else
	#include "surface_mesh_eggwhite_0111.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0111.txt"
#else
	#include "surface_mesh_yolk0_0111.inc"
