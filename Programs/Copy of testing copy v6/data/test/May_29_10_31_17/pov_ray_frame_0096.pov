/* average times: interact=0.497719 s/f, motion=1.543812 s/f, downsample=0.002281 s/f, upsample=0.159656 s/f, and total=7.429229 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0096.txt"
#else
	#include "surface_mesh_eggwhite_0096.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0096.txt"
#else
	#include "surface_mesh_yolk0_0096.inc"
