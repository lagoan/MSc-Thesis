/* average times: interact=0.573690 s/f, motion=1.941416 s/f, downsample=0.003469 s/f, upsample=0.220265 s/f, and total=7.846832 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0113.txt"
#else
	#include "surface_mesh_eggwhite_0113.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0113.txt"
#else
	#include "surface_mesh_yolk0_0113.inc"
