/* average times: interact=0.250423 s/f, motion=0.738833 s/f, downsample=0.000205 s/f, upsample=0.031244 s/f, and total=6.677308 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0078.txt"
#else
	#include "surface_mesh_eggwhite_0078.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0078.txt"
#else
	#include "surface_mesh_yolk0_0078.inc"
