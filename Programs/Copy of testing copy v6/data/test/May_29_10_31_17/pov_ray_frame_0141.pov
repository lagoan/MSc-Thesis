/* average times: interact=0.688333 s/f, motion=2.413106 s/f, downsample=0.004440 s/f, upsample=0.276482 s/f, and total=8.189255 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0141.txt"
#else
	#include "surface_mesh_eggwhite_0141.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0141.txt"
#else
	#include "surface_mesh_yolk0_0141.inc"
