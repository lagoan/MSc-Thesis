/* average times: interact=0.502412 s/f, motion=1.562691 s/f, downsample=0.002258 s/f, upsample=0.158010 s/f, and total=7.448804 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0097.txt"
#else
	#include "surface_mesh_eggwhite_0097.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0097.txt"
#else
	#include "surface_mesh_yolk0_0097.inc"
