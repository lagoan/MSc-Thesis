/* average times: interact=0.601748 s/f, motion=2.076824 s/f, downsample=0.004210 s/f, upsample=0.245916 s/f, and total=7.964950 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0119.txt"
#else
	#include "surface_mesh_eggwhite_0119.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0119.txt"
#else
	#include "surface_mesh_yolk0_0119.inc"
