/* average times: interact=0.514680 s/f, motion=1.640030 s/f, downsample=0.002500 s/f, upsample=0.176240 s/f, and total=7.531430 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0100.txt"
#else
	#include "surface_mesh_eggwhite_0100.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0100.txt"
#else
	#include "surface_mesh_yolk0_0100.inc"
