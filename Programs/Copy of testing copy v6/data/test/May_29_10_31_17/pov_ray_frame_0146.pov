/* average times: interact=0.705110 s/f, motion=2.467377 s/f, downsample=0.004288 s/f, upsample=0.278247 s/f, and total=8.211911 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0146.txt"
#else
	#include "surface_mesh_eggwhite_0146.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0146.txt"
#else
	#include "surface_mesh_yolk0_0146.inc"
