/* average times: interact=0.172527 s/f, motion=0.487757 s/f, downsample=0.000000 s/f, upsample=0.001676 s/f, and total=6.439162 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0074.txt"
#else
	#include "surface_mesh_eggwhite_0074.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0074.txt"
#else
	#include "surface_mesh_yolk0_0074.inc"
