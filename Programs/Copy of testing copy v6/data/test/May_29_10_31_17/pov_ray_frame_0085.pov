/* average times: interact=0.389529 s/f, motion=1.146929 s/f, downsample=0.001294 s/f, upsample=0.087494 s/f, and total=7.051141 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0085.txt"
#else
	#include "surface_mesh_eggwhite_0085.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0085.txt"
#else
	#include "surface_mesh_yolk0_0085.inc"
