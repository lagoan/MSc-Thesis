/* average times: interact=0.658316 s/f, motion=2.301571 s/f, downsample=0.004353 s/f, upsample=0.264444 s/f, and total=8.123474 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0133.txt"
#else
	#include "surface_mesh_eggwhite_0133.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0133.txt"
#else
	#include "surface_mesh_yolk0_0133.inc"
