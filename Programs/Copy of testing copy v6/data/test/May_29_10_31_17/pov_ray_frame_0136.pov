/* average times: interact=0.669868 s/f, motion=2.348691 s/f, downsample=0.004375 s/f, upsample=0.272051 s/f, and total=8.153721 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0136.txt"
#else
	#include "surface_mesh_eggwhite_0136.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0136.txt"
#else
	#include "surface_mesh_yolk0_0136.inc"
