/* average times: interact=0.691852 s/f, motion=2.422310 s/f, downsample=0.004408 s/f, upsample=0.274535 s/f, and total=8.192218 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0142.txt"
#else
	#include "surface_mesh_eggwhite_0142.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0142.txt"
#else
	#include "surface_mesh_yolk0_0142.inc"
