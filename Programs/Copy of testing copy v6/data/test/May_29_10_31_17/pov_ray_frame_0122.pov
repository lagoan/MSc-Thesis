/* average times: interact=0.616123 s/f, motion=2.121418 s/f, downsample=0.004107 s/f, upsample=0.239869 s/f, and total=7.995910 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0122.txt"
#else
	#include "surface_mesh_eggwhite_0122.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0122.txt"
#else
	#include "surface_mesh_yolk0_0122.inc"
