/* average times: interact=0.698403 s/f, motion=2.450632 s/f, downsample=0.004347 s/f, upsample=0.282111 s/f, and total=8.207792 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0144.txt"
#else
	#include "surface_mesh_eggwhite_0144.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0144.txt"
#else
	#include "surface_mesh_yolk0_0144.inc"
