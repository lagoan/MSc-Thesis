/* average times: interact=0.701779 s/f, motion=2.459055 s/f, downsample=0.004317 s/f, upsample=0.280166 s/f, and total=8.209697 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0145.txt"
#else
	#include "surface_mesh_eggwhite_0145.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0145.txt"
#else
	#include "surface_mesh_yolk0_0145.inc"
