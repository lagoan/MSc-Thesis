/* average times: interact=0.532731 s/f, motion=1.738894 s/f, downsample=0.002712 s/f, upsample=0.194106 s/f, and total=7.639740 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0104.txt"
#else
	#include "surface_mesh_eggwhite_0104.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0104.txt"
#else
	#include "surface_mesh_yolk0_0104.inc"
