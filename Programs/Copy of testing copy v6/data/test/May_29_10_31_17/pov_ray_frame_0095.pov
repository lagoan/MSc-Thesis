/* average times: interact=0.493105 s/f, motion=1.524537 s/f, downsample=0.002305 s/f, upsample=0.161337 s/f, and total=7.408747 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0095.txt"
#else
	#include "surface_mesh_eggwhite_0095.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0095.txt"
#else
	#include "surface_mesh_yolk0_0095.inc"
