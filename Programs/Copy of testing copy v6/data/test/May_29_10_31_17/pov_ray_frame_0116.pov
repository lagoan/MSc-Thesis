/* average times: interact=0.587655 s/f, motion=2.010112 s/f, downsample=0.003784 s/f, upsample=0.232879 s/f, and total=7.908414 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0116.txt"
#else
	#include "surface_mesh_eggwhite_0116.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0116.txt"
#else
	#include "surface_mesh_yolk0_0116.inc"
