/* average times: interact=0.677370 s/f, motion=2.369449 s/f, downsample=0.004312 s/f, upsample=0.268109 s/f, and total=8.162812 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0138.txt"
#else
	#include "surface_mesh_eggwhite_0138.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0138.txt"
#else
	#include "surface_mesh_yolk0_0138.inc"
