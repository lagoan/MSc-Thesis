/* average times: interact=0.650244 s/f, motion=2.277672 s/f, downsample=0.004420 s/f, upsample=0.268481 s/f, and total=8.110092 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0131.txt"
#else
	#include "surface_mesh_eggwhite_0131.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0131.txt"
#else
	#include "surface_mesh_yolk0_0131.inc"
