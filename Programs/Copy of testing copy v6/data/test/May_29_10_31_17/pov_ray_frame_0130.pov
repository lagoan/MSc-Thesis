/* average times: interact=0.646346 s/f, motion=2.250115 s/f, downsample=0.004338 s/f, upsample=0.254669 s/f, and total=8.086892 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0130.txt"
#else
	#include "surface_mesh_eggwhite_0130.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0130.txt"
#else
	#include "surface_mesh_yolk0_0130.inc"
