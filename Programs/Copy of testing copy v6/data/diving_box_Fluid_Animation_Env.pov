...
texture {                                     
   pigment {color <0.75, 0.95, 0.75>  filter 0.995 }
   finish {
      specular 0.95
      roughness 0.02
      ambient 0.75
...
#declare Pos_Translate_x = -20;
#declare My_Focus_Position = <Pos_Translate_x, 50.0000, 0.0000>;
#declare My_Camera_Location = <Pos_Translate_x, 50.0000, -600.0000>;
...
#declare Floor =
plane {
   y, floor__m_bssCtrPos.y - Floor_Thickness
   pigment {
        image_map {jpeg "Wood-Light-birch.jpg"}
        rotate <0, -80, 0>       
