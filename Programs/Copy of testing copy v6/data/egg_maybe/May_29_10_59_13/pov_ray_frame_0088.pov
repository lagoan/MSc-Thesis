/* average times: interact=0.428966 s/f, motion=1.278591 s/f, downsample=0.001591 s/f, upsample=0.112773 s/f, and total=7.124352 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0088.txt"
#else
	#include "surface_mesh_eggwhite_0088.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0088.txt"
#else
	#include "surface_mesh_yolk0_0088.inc"
