/* average times: interact=0.573184 s/f, motion=1.939596 s/f, downsample=0.003158 s/f, upsample=0.211781 s/f, and total=7.807079 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0114.txt"
#else
	#include "surface_mesh_eggwhite_0114.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0114.txt"
#else
	#include "surface_mesh_yolk0_0114.inc"
