/* average times: interact=0.606025 s/f, motion=2.088380 s/f, downsample=0.003893 s/f, upsample=0.236198 s/f, and total=7.933314 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0121.txt"
#else
	#include "surface_mesh_eggwhite_0121.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0121.txt"
#else
	#include "surface_mesh_yolk0_0121.inc"
