/* average times: interact=0.042265 s/f, motion=0.110971 s/f, downsample=0.000000 s/f, upsample=0.000000 s/f, and total=6.020515 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0068.txt"
#else
	#include "surface_mesh_eggwhite_0068.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0068.txt"
#else
	#include "surface_mesh_yolk0_0068.inc"
