/* average times: interact=0.208461 s/f, motion=0.621934 s/f, downsample=0.000197 s/f, upsample=0.031868 s/f, and total=6.517145 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0076.txt"
#else
	#include "surface_mesh_eggwhite_0076.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0076.txt"
#else
	#include "surface_mesh_yolk0_0076.inc"
