/* average times: interact=0.326793 s/f, motion=0.958683 s/f, downsample=0.000756 s/f, upsample=0.057171 s/f, and total=6.824585 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0082.txt"
#else
	#include "surface_mesh_eggwhite_0082.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0082.txt"
#else
	#include "surface_mesh_yolk0_0082.inc"
