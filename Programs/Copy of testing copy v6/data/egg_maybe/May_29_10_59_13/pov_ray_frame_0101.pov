/* average times: interact=0.513446 s/f, motion=1.639109 s/f, downsample=0.002317 s/f, upsample=0.168030 s/f, and total=7.490624 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0101.txt"
#else
	#include "surface_mesh_eggwhite_0101.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0101.txt"
#else
	#include "surface_mesh_yolk0_0101.inc"
