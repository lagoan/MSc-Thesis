/* average times: interact=0.539271 s/f, motion=1.792234 s/f, downsample=0.002776 s/f, upsample=0.203150 s/f, and total=7.655131 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0107.txt"
#else
	#include "surface_mesh_eggwhite_0107.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0107.txt"
#else
	#include "surface_mesh_yolk0_0107.inc"
