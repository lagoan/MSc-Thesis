/* average times: interact=0.622768 s/f, motion=2.158672 s/f, downsample=0.004016 s/f, upsample=0.244640 s/f, and total=7.984832 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0125.txt"
#else
	#include "surface_mesh_eggwhite_0125.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0125.txt"
#else
	#include "surface_mesh_yolk0_0125.inc"
