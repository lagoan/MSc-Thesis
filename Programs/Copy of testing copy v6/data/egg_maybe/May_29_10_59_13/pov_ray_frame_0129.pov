/* average times: interact=0.637504 s/f, motion=2.220876 s/f, downsample=0.004140 s/f, upsample=0.251341 s/f, and total=8.029295 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0129.txt"
#else
	#include "surface_mesh_eggwhite_0129.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0129.txt"
#else
	#include "surface_mesh_yolk0_0129.inc"
