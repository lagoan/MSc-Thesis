/* average times: interact=0.189787 s/f, motion=0.568347 s/f, downsample=0.000200 s/f, upsample=0.032293 s/f, and total=6.467787 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0075.txt"
#else
	#include "surface_mesh_eggwhite_0075.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0075.txt"
#else
	#include "surface_mesh_yolk0_0075.inc"
