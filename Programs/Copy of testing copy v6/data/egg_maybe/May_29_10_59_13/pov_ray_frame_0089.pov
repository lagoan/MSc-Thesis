/* average times: interact=0.440124 s/f, motion=1.310045 s/f, downsample=0.001573 s/f, upsample=0.111506 s/f, and total=7.153326 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0089.txt"
#else
	#include "surface_mesh_eggwhite_0089.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0089.txt"
#else
	#include "surface_mesh_yolk0_0089.inc"
