/* average times: interact=0.501582 s/f, motion=1.561245 s/f, downsample=0.002071 s/f, upsample=0.149888 s/f, and total=7.404235 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0098.txt"
#else
	#include "surface_mesh_eggwhite_0098.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0098.txt"
#else
	#include "surface_mesh_yolk0_0098.inc"
