/* average times: interact=0.000000 s/f, motion=0.000889 s/f, downsample=0.000000 s/f, upsample=0.000000 s/f, and total=5.862000 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0018.txt"
#else
	#include "surface_mesh_eggwhite_0018.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0018.txt"
#else
	#include "surface_mesh_yolk0_0018.inc"
