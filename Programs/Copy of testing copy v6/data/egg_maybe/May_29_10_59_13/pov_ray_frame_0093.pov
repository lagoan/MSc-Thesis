/* average times: interact=0.474624 s/f, motion=1.437527 s/f, downsample=0.001839 s/f, upsample=0.132075 s/f, and total=7.274441 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0093.txt"
#else
	#include "surface_mesh_eggwhite_0093.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0093.txt"
#else
	#include "surface_mesh_yolk0_0093.inc"
