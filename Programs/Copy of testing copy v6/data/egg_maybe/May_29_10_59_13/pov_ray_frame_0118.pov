/* average times: interact=0.591364 s/f, motion=2.022814 s/f, downsample=0.003585 s/f, upsample=0.222737 s/f, and total=7.879966 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0118.txt"
#else
	#include "surface_mesh_eggwhite_0118.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0118.txt"
#else
	#include "surface_mesh_yolk0_0118.inc"
