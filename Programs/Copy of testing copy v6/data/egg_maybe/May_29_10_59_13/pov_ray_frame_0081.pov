/* average times: interact=0.305556 s/f, motion=0.908580 s/f, downsample=0.000765 s/f, upsample=0.057877 s/f, and total=6.780160 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0081.txt"
#else
	#include "surface_mesh_eggwhite_0081.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0081.txt"
#else
	#include "surface_mesh_yolk0_0081.inc"
