/* average times: interact=0.285338 s/f, motion=0.859000 s/f, downsample=0.000775 s/f, upsample=0.058600 s/f, and total=6.734650 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0080.txt"
#else
	#include "surface_mesh_eggwhite_0080.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0080.txt"
#else
	#include "surface_mesh_yolk0_0080.inc"
