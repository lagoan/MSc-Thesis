/* average times: interact=0.522301 s/f, motion=1.699689 s/f, downsample=0.002583 s/f, upsample=0.188738 s/f, and total=7.555748 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0103.txt"
#else
	#include "surface_mesh_eggwhite_0103.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0103.txt"
#else
	#include "surface_mesh_yolk0_0103.inc"
