/* average times: interact=0.226870 s/f, motion=0.675338 s/f, downsample=0.000195 s/f, upsample=0.031455 s/f, and total=6.568857 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0077.txt"
#else
	#include "surface_mesh_eggwhite_0077.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0077.txt"
#else
	#include "surface_mesh_yolk0_0077.inc"
