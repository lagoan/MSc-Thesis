/* average times: interact=0.601175 s/f, motion=2.073358 s/f, downsample=0.003925 s/f, upsample=0.238167 s/f, and total=7.922342 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0120.txt"
#else
	#include "surface_mesh_eggwhite_0120.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0120.txt"
#else
	#include "surface_mesh_yolk0_0120.inc"
