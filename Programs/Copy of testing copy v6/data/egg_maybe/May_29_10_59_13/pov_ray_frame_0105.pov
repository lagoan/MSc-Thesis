/* average times: interact=0.531248 s/f, motion=1.735895 s/f, downsample=0.002533 s/f, upsample=0.185143 s/f, and total=7.596038 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0105.txt"
#else
	#include "surface_mesh_eggwhite_0105.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0105.txt"
#else
	#include "surface_mesh_yolk0_0105.inc"
