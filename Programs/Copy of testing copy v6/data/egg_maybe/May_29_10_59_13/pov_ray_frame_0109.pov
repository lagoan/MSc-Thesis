/* average times: interact=0.548459 s/f, motion=1.827596 s/f, downsample=0.002725 s/f, upsample=0.199422 s/f, and total=7.693725 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0109.txt"
#else
	#include "surface_mesh_eggwhite_0109.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0109.txt"
#else
	#include "surface_mesh_yolk0_0109.inc"
