/* average times: interact=0.633945 s/f, motion=2.209422 s/f, downsample=0.004172 s/f, upsample=0.253305 s/f, and total=8.022688 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0128.txt"
#else
	#include "surface_mesh_eggwhite_0128.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0128.txt"
#else
	#include "surface_mesh_yolk0_0128.inc"
