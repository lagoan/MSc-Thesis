/* average times: interact=0.553264 s/f, motion=1.845636 s/f, downsample=0.002700 s/f, upsample=0.197609 s/f, and total=7.716391 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0110.txt"
#else
	#include "surface_mesh_eggwhite_0110.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0110.txt"
#else
	#include "surface_mesh_yolk0_0110.inc"
