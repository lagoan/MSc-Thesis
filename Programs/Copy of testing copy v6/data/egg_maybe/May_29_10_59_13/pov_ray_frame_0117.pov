/* average times: interact=0.586667 s/f, motion=2.006718 s/f, downsample=0.003615 s/f, upsample=0.224641 s/f, and total=7.866248 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0117.txt"
#else
	#include "surface_mesh_eggwhite_0117.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0117.txt"
#else
	#include "surface_mesh_yolk0_0117.inc"
