/* average times: interact=0.346771 s/f, motion=1.038253 s/f, downsample=0.001313 s/f, upsample=0.087554 s/f, and total=6.899566 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0083.txt"
#else
	#include "surface_mesh_eggwhite_0083.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0083.txt"
#else
	#include "surface_mesh_yolk0_0083.inc"
