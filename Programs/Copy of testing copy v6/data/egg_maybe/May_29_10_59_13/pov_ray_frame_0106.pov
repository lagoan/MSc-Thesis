/* average times: interact=0.534925 s/f, motion=1.753123 s/f, downsample=0.002509 s/f, upsample=0.183396 s/f, and total=7.615028 s/f. */
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_eggwhite_0106.txt"
#else
	#include "surface_mesh_eggwhite_0106.inc"
	object { eggwhite translate Translate_eggwhite material { My_Fluid_Material_1 } }
#end

#if (display_particles_2)
	#include "prtl_yolk0_0106.txt"
#else
	#include "surface_mesh_yolk0_0106.inc"
