/* average times: interact=0.000000 s/f, motion=0.014611 s/f, downsample=0.000000 s/f, upsample=0.000000 s/f, and total=4.070167 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -38.531250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0018.txt"
#else
	#include "surface_mesh_fluid_box_0018.inc"
