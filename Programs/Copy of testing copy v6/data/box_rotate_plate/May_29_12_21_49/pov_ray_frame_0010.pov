/* average times: interact=0.000000 s/f, motion=0.021800 s/f, downsample=0.000000 s/f, upsample=0.000000 s/f, and total=4.062400 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -20.531250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0010.txt"
#else
	#include "surface_mesh_fluid_box_0010.inc"
