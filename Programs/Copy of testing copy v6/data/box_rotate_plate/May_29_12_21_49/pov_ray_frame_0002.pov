/* average times: interact=0.000000 s/f, motion=0.031000 s/f, downsample=0.000000 s/f, upsample=0.000000 s/f, and total=3.945000 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -2.531250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0002.txt"
#else
	#include "surface_mesh_fluid_box_0002.inc"
