/* average times: interact=0.001069 s/f, motion=1.808103 s/f, downsample=0.003241 s/f, upsample=0.413276 s/f, and total=5.880793 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -63.281250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0029.txt"
#else
	#include "surface_mesh_fluid_box_0029.inc"
