/* average times: interact=0.000667 s/f, motion=0.869000 s/f, downsample=0.001292 s/f, upsample=0.130250 s/f, and total=4.921083 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -52.031250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0024.txt"
#else
	#include "surface_mesh_fluid_box_0024.inc"
