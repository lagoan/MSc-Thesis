/* average times: interact=0.000000 s/f, motion=0.635087 s/f, downsample=0.000696 s/f, upsample=0.070000 s/f, and total=4.683304 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -49.781250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0023.txt"
#else
	#include "surface_mesh_fluid_box_0023.inc"
