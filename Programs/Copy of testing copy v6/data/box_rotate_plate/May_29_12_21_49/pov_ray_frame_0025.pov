/* average times: interact=0.000640 s/f, motion=1.098040 s/f, downsample=0.001880 s/f, upsample=0.199400 s/f, and total=5.156800 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -54.281250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0025.txt"
#else
	#include "surface_mesh_fluid_box_0025.inc"
