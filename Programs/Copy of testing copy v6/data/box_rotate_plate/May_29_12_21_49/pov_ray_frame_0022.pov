/* average times: interact=0.000000 s/f, motion=0.374955 s/f, downsample=0.000727 s/f, upsample=0.001409 s/f, and total=4.420364 s/f. */
...
#declare solid_rod_1__m_rtzaRotationAngleAboutZAxis = -47.531250;
...
#include "Fluid_Animation_Env.pov"
	...
	#include "prtl_fluid_box_0022.txt"
#else
	#include "surface_mesh_fluid_box_0022.inc"
