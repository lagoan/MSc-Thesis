...
void CParticleSearch::RegisterPrtls(int numPrtls, CFluidPrtl** aryPrtls, bool mixFluidWithBubble)
{
	...
	{
		if (mixFluidWithBubble == true ||
			aryPrtls[i]->m_bpIsBubble == false) {
