...
CVector3D::CVector3D(SimuValue elem1, SimuValue elem2, SimuValue elem3)
{
	SetElements(elem1, elem2, elem3);
}
...
/////////////////////////////////////////////////////////////////////////////////////
bool CVector3D::ParseStringForValue(QString str)
{
	char location[] = "CVector3D::ParseStringForValue(str)";

	if (str.size() > LEN_DATA_LINE)
	{
...
void CVector3D::MakeStringFromValue(QString &str)
{
