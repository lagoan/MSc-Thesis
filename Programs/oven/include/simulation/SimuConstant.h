...
#ifndef SIMUCONSTANT_H
#define SIMUCONSTANT_H
...
#define DOUBLE_VALUE
	...
	#define SIMU_PI				3.14159265358979323846
...
#define SIMU_VALUE_2PI		SIMU_PI*2
...
//#define GRAVITY_ACCELERATION	"0.0, -98.0, 0.0"

#define SIZE_MODIFIER 1000.0f
#define GRAVITY_ACCELERATION	"0.0, -980f, 0.0" // cm
...
const SimuValue SIMU_CONST_DEGREE_RADIAN_RATIO = SIMU_PI/180.0;
const SimuValue SIMU_CONST_SPIKY_NORMALIZER = 15.0/SIMU_PI;
const SimuValue SIMU_CONST_PRESSURE_LAPLACIAN = 45/SIMU_PI;
