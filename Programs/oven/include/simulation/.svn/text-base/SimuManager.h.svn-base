...
public:
	...
	static int m_numFluidBubbleInteractionFrequency;
	...
	// baking parameters
	static bool		 BAKE_FLUIDS;
	static SimuValue m_startCookTime;
	//static SimuValue m_CO2PeakGeneration;
	//static SimuValue m_CO2TemperatureMean;
	//static SimuValue m_CO2TemperatureRange;
	//static SimuValue m_CO2AreaUnderRateCurve;



	// thermal model parameters
	//static bool		GENERATE_CO2;
	static bool		AMBIENT_HEAT_TRANSFER;
	...
	static QString	m_strAppDataDir;
	static QString	m_strImportDir;
	static QString	m_strImportParaFile;
	static unsigned int		m_nImportFrameInterval;
	...
	static QString	m_strExportDir;
	static QString	m_strSimuInfoFile;
	static QString	m_strSimuEnvPOVFile;
	...
	bool	m_bGo;
	unsigned int	m_uFwdIntvls;
		
	unsigned int	m_uPrevFwdIntvls;
	QString	m_strSimuPropInfo;
	double	m_dbFrameIntvl;
	bool	m_bEnableMessage;
	double	m_dbAnimationClock;
	float	m_fFluidDensity;
	float	m_fPrtlMass;
	QString	m_strAverageTime;
...
public:
	...
	QMap<QString, QString>	m_cParaList;
...
// Operations
public:
	static time_t GetDirectoryCreationTime(QString dir);
	...
	void DisplayOperationCountingMessage(const char* elmntName,
										...
										unsigned int period=100, bool bDisabled=true);
...
private:
	...
	QString		m_strPOVAppName;
	CVector*	m_pMainWinRect;

	time_t		m_tNewImExportFormatTime;

	bool DelimiteNameValuePair(char* src, QString& name, QString& string);
