...
public:
	...
	static void AssertSimuValue(SimuValue value, QString location);
	static void AssertSimuVector3D(CVector3D* vector, QString location);

	static bool FileDoesExist(QString fileName);
