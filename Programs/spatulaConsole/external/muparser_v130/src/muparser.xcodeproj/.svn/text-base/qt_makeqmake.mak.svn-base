#############################################################################
# Makefile for building: libmuparser.a
# Generated by qmake (2.01a) (Qt 4.5.2) on: Sun Oct 4 22:25:41 2009
# Project:  src.pro
# Template: lib
# Command: /usr/bin/qmake-4.5 -macx -o muparser.xcodeproj/project.pbxproj src.pro
#############################################################################

QMAKE    = /usr/bin/qmake-4.5
muparser.xcodeproj/project.pbxproj: src.pro  /usr/local/Qt4.5/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.5/mkspecs/common/unix.conf \
	...
	$(QMAKE) -macx -o muparser.xcodeproj/project.pbxproj src.pro
