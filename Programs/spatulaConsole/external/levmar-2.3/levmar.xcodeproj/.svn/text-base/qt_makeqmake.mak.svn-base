#############################################################################
# Makefile for building: liblevmar.a
# Generated by qmake (2.01a) (Qt 4.5.2) on: Sun Oct 4 22:25:41 2009
# Project:  levmar-2.3.pro
# Template: lib
# Command: /usr/bin/qmake-4.5 -macx -o levmar.xcodeproj/project.pbxproj.levmar-2 levmar-2.3.pro
#############################################################################

QMAKE    = /usr/bin/qmake-4.5
levmar.xcodeproj/project.pbxproj.levmar-2: levmar-2.3.pro  /usr/local/Qt4.5/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.5/mkspecs/common/unix.conf \
	...
	$(QMAKE) -macx -o levmar.xcodeproj/project.pbxproj.levmar-2 levmar-2.3.pro
