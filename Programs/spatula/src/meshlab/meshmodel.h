...
class CVertexO  : public vcg::VertexSimp2< CVertexO, CEdgeO, CFaceO,
...
class CEdgeO : public vcg::EdgeSimp2<CVertexO,CEdgeO,CFaceO, vcg::edge::EVAdj> {
public:
	inline CEdgeO(){};
...
class CFaceO    : public vcg::FaceSimp2<  CVertexO, CEdgeO, CFaceO,
      vcg::face::InfoOcf,              /* 4b */
