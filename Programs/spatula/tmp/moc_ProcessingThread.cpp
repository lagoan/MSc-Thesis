...
**
** Created: Sun Jan 30 19:53:38 2011
...
static const char qt_meta_stringdata_ProcessingThread[] = {
    "ProcessingThread\0\0updateLog(QString)\0"
    "finishedFile(int)\0fileProgress(int)\0"
    "actionProgress(int)\0taskProgress(int)\0"
};
...
int ProcessingThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: updateLog((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: finishedFile((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: fileProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: actionProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: taskProgress((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 5;
    }
...
// SIGNAL 0
void ProcessingThread::updateLog(QString _t1)
{
...
// SIGNAL 1
void ProcessingThread::finishedFile(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void ProcessingThread::fileProgress(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void ProcessingThread::actionProgress(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
